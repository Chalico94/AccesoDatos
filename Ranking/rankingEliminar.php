...
<div>
    ...
    <input type ="text" name="nombre" placeholder="Filtrar por nombre..."  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/>
    <br/>
